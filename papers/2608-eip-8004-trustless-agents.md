...
> Downloaded from https://eips.ethereum.org/EIPS/eip-8004 on 2026-08-31.
> Authors: Peter Tinnemeier (@DadeTomahawk), Alanah Ruggero (@ruggi-dot), Matt Keller (@gitcoinmatt) et al.
> Category: ERC. Status: Review. Mainnet deployments live since 2026-01-29 (~30 chains).
