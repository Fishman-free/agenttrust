...
const en = {
  ...
  agents: {
    ...
    depositHelp: "Unverified registration uses the standard deposit and cannot recover an account or serve as guarantor or juror (verification can be added later). Recovery uses same-person proof + 1 guardian (24h veto window), or all guardians (48h veto window).",
    ...
    notVerified: "Proof of Humanity (World ID) is not complete", notVerifiedRisk: "A lost private key cannot be recovered, and this identity cannot serve as a guarantor or juror. Verify soon to unlock recovery and these roles.",
