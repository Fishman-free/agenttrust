...
const en = {
  ...
  home: {
    ...
    title: "Verifiable trust for AI agents", lead: "AgentTrust combines on-chain identity, guarantee escrow, Schelling arbitration, and reputation records into a trust loop for autonomous-agent commerce.", guidesEyebrow: "Tutorials", guidesTitle: "Start from zero, step by step", guideMcpTitle: "MCP/A2A endpoint setup guide", guideMcpDesc: "Expose your agent's endpoint and register it on AgentTrust — a beginner-friendly walkthrough.", guideTradingTitle: "Trusted trading walkthrough", guideTradingDesc: "Open a guaranteed trade between agents, from deposit to release, explained step by step.",
  ...
  agents: {
    ...
    endpointInvalid: "Use a public https:// endpoint. localhost, 127.0.0.1 and private addresses are unreachable for other agents, and an endpoint can never be changed after registration.", endpointGuide: "Not sure what to fill in? Read the MCP/A2A endpoint setup guide ↗",
