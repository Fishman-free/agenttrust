...
const en = {
  ...
  auth: { login: "Sign in", logout: "Sign out", status: "Authentication status", signedIn: "Signed in", checking: "Checking session…", redirectingCanonical: "Authentication API unavailable. Redirecting to agenttrust.site…", accessEyebrow: "Secure workspace access", accessEyebrowTag: "Auth BFF · SIWE session", heroEyebrow: "Sign in", heroTitle: "Identity, signed by you.", heroTitleEmphasized: "signed by you.", heroLead: "Authenticate the workspace once, then handle every on-chain action from a separate wallet control. No shared tokens, no silent auto-login.", benefitSession: "Server-managed session via the Auth BFF", benefitWallet: "SIWE binds the session to the signed wallet", benefitSeparate: "Authentication and transaction wallet status stay distinct", loginOptions: "Sign-in options", recommended: "Recommended", walletTitle: "Wallet account", walletDescription: "Connect and sign a one-time SIWE challenge. The Auth BFF creates the session; no session token is stored in browser storage.", walletBadge: "Best for on-chain users", socialBadge: "Web2 — pick your account", providersHeading: "Sign in with a social account", providersHint: "Each button is hidden when the underlying provider is not configured in the Auth BFF.", signing: "Waiting for signature…", signWallet: "Sign in with connected wallet", connectAndSign: "Connect wallet and sign in", walletMissing: "No wallet account is available.", loginFailed: "Sign-in failed.", continueCanonical: "Continue on agenttrust.site", configuring: "Configuring", setupRequired: "Setup required (Auth BFF)", setupHint: "Set the matching OIDC issuer, client ID, client secret, and redirect URI in the Auth BFF environment. See auth-bff/.env.example and auth-bff/README.md.", availableSoon: "Available soon", strongIdentityTitle: "Strong identity registration", strongIdentityPlaceholder: "Planned. No government-ID or real-name verification is currently offered.", planned: "Planned", labs: "Labs", worldIdLabs: "World ID is an experimental Proof-of-Humanity signal for anti-Sybil role gates. It is not real-name verification and does not establish legal identity.", continueWith: "Continue", redirecting: "Redirecting…", walletUnavailable: "Wallet SIWE login is not available on this Auth BFF.", walletGate: "Wallet binding", walletLinkTitle: "Bind a transaction wallet", walletLinkBody: "This social account has no wallet binding. Connect the wallet you will use for AgentTrust writes, then sign a fresh one-time link challenge.", walletMismatchTitle: "Connected wallet does not match", walletMismatchBody: "The connected wallet differs from this account's binding. Disconnect it and switch to the already bound wallet. Wallet replacement is not available in this version.", boundWallet: "Bound wallet", connectedWallet: "Connected wallet", linkWallet: "Bind this wallet", matchWallet: "Match this wallet", walletLinkFailed: "Wallet binding failed." },
  ...
  walletPicker: {
    ...
    previousAttemptInterrupted: "Your last attempt to connect to {name} was interrupted. Pick any wallet to start a fresh attempt.",
...
const zhCN: Dictionary = {
  ...
  auth: { login: "登录", logout: "退出登录", status: "认证状态", signedIn: "已登录", checking: "正在检查会话…", redirectingCanonical: "认证 API 不可用，正在前往 agenttrust.site…", accessEyebrow: "安全访问工作台", accessEyebrowTag: "Auth BFF · SIWE 会话", heroEyebrow: "登录", heroTitle: "身份由你亲自签名。", heroTitleEmphasized: "由你亲自签名。", heroLead: "工作台只需认证一次；之后每次链上操作都从单独的钱包控制发出。不共享令牌，也没有静默自动登录。", benefitSession: "由 Auth BFF 管理服务器会话", benefitWallet: "SIWE 将会话绑定至签名钱包", benefitSeparate: "认证状态与交易钱包状态保持分离", loginOptions: "登录方式", recommended: "推荐", walletTitle: "钱包账户", walletDescription: "连接钱包并签署一次性 SIWE 挑战。会话由 Auth BFF 创建，浏览器存储中不保存会话令牌。", walletBadge: "推荐给链上用户", socialBadge: "Web2 — 选择账户", providersHeading: "通过社交账号登录", providersHint: "未在 Auth BFF 配置的按钮会自动隐藏。", signing: "等待签名…", signWallet: "使用已连接钱包登录", connectAndSign: "连接钱包并签名登录", walletMissing: "没有可用的钱包账户。", loginFailed: "登录失败。", continueCanonical: "前往 agenttrust.site 继续", configuring: "配置中", setupRequired: "需配置（Auth BFF）", setupHint: "请在 Auth BFF 环境变量中填写对应的 OIDC issuer、client id、client secret 与 redirect URI，详见 auth-bff/.env.example 与 auth-bff/README.md。", availableSoon: "即将开放", strongIdentityTitle: "强身份注册", strongIdentityPlaceholder: "规划中。当前不提供政府证件核验或实名认证。", planned: "规划中", labs: "Labs 实验室", worldIdLabs: "World ID 是用于防女巫角色门禁的实验性人类证明信号，不是实名认证，也不建立法律身份。", continueWith: "继续登录", redirecting: "正在跳转…", walletUnavailable: "当前 Auth BFF 未开放钱包 SIWE 登录。", walletGate: "钱包绑定", walletLinkTitle: "绑定交易钱包", walletLinkBody: "此社交账户尚未绑定钱包。请连接将用于 AgentTrust 写操作的钱包，并签署新的单次绑定挑战。", walletMismatchTitle: "连接钱包与绑定不一致", walletMismatchBody: "当前连接钱包不同于账户绑定。请断开并切换回已经绑定的钱包；此版本不提供钱包替换功能。", boundWallet: "已绑定钱包", connectedWallet: "当前连接钱包", linkWallet: "绑定此钱包", matchWallet: "匹配此钱包", walletLinkFailed: "钱包绑定失败。" },
