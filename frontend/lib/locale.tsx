...
const en = {
  ...
  agents: {
    ...
    endpointInvalid: "Use a public https:// endpoint. localhost, 127.0.0.1 and private addresses are unreachable for other agents, and an endpoint can never be changed after registration.",
